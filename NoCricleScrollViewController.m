//
//  NoCricleScrollViewController.m
//  DJSuperScrollView
//
...
@interface NoCricleScrollViewController ()
{
    DJScrollView *scroll;
}
@end

@implementation NoCricleScrollViewController
...
- (void)viewDidLoad {
     ...
     */
    scroll.imageArray = @[@"m9.jpg",@"m10.jpg",@"m11.jpg",@"m12.jpg",@"m13.jpg",@"m15.jpg"];
    
    UIButton *butoon = [scroll.myScroll viewWithTag:520];
    
    [butoon addTarget:self action:@selector(clickButton:) forControlEvents:UIControlEventTouchUpInside];
